...
namespace _365EJSC.ERP.Application.Tests.Define.WebLocalWards
{
    public class GetWebLocalWardByIdTest
    {
        ...
        {
            // Arrange
            var sample = new Entities.WebLocalWard { Id = 1, Name = "Ward 1", WebLocalDistrict = new Entities.WebLocalDistrict { WebLocalProvince = new Entities.WebLocalProvince() } };

            mockWardRepository
                .Setup(r => r.FindByIdAsync(1, true, It.IsAny<CancellationToken>(), It.IsAny<Expression<Func<Entities.WebLocalWard, object>>[]>()))
                .ReturnsAsync(sample);
        ...
        public async Task Handle_Should_Return_NotFound_When_Sample_NotFound()
        {
            ...
            mockWardRepository
                .Setup(r => r.FindByIdAsync(99, true, It.IsAny<CancellationToken>(), It.IsAny<Expression<Func<Entities.WebLocalWard, object>>[]>()))
                .ReturnsAsync((Entities.WebLocalWard)null);
