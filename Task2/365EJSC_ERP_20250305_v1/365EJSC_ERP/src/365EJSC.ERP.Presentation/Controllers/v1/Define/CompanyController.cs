...
namespace _365EJSC.ERP.Presentation.Controllers.v1.Define
{
    ...
    /// </summary>
    [ApiVersion(1)]
    [Route(RouteConstant.API_PREFIX + RouteConstant.COMPANY_ROUTE)]
    public class CompanyController : ApiController
    {
        ...
        [MapToApiVersion(1)]
        [HttpPost]
        public async Task<IActionResult> CreateV1(CreateCompanyRequest request)
        {
        ...
        [MapToApiVersion(1)]
        [HttpPut]
        public async Task<IActionResult> UpdateV1(int id, [FromBody] UpdateCompanyRequest request)
        {
            request.Id = id;
            var result = await mediator.Send(request);
            return Ok(result);
        ...
        {
            var command = new DeleteCompanyRequest()
            {
                Id = id,
            };
        ...
        {
            var query = new GetDetailCompanyRequest()
            {
                Id = id,
            };
