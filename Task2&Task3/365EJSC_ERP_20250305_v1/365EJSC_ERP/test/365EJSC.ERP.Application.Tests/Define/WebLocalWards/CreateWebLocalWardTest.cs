    ...
    public class CreateWebLocalWardTest
    {
        ...
        public async Task Handle_ShouldThrowNotFoundException_WhenCustomerIdNotFound()
        {
            ...
            mockDictrictSqlRepository
                .Setup(repo => repo.IsExistAsync(It.IsAny<Expression<Func<Entities.WebLocalDistrict, bool>>>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(false);
        ...
        public async Task Handle_ShouldThrowConflictException_WhenWardAlreadyExists()
        {
            ...
            mockDictrictSqlRepository.Setup(repo => repo.IsExistAsync(It.IsAny<Expression<Func<Entities.WebLocalDistrict, bool>>>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(true);
