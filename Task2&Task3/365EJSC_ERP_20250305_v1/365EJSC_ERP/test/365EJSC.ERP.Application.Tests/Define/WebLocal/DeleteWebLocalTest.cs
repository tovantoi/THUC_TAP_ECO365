...
{
    public class DeleteWebLocalTest
    {
        private readonly Mock<IWebLocalSqlRepository> mockWebLocalSqlRepository;
        private readonly Mock<ISqlUnitOfWork> mockSqlUnitOfWork;
        private readonly DeleteWebLocalHandler handler;

        public DeleteWebLocalTest()
        {
            mockWebLocalSqlRepository = new Mock<IWebLocalSqlRepository>();
            mockSqlUnitOfWork = new Mock<ISqlUnitOfWork>();
            handler = new DeleteWebLocalHandler(mockWebLocalSqlRepository.Object, mockSqlUnitOfWork.Object);
        }
        ...
        {
            // Arrange
            var request = new DeleteWebLocalRequest { Id = "AAA" };
            ...
            mockWebLocalSqlRepository.Verify(repo => repo.Update(It.IsAny<WebLocals>()), Times.Once);
        ...
        public async Task Handle_ExceptionOccurs_TransactionRollsBack()
        {
            ...
            mockWebLocalSqlRepository
                .Setup(repo => repo.Update(It.IsAny<WebLocals>()))
