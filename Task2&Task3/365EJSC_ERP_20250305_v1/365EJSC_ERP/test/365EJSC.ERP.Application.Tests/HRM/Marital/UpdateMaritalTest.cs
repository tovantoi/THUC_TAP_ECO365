...
{
    public class UpdateMaritalTest
    {
        private readonly Mock<IMaritalSqlRepository> mockMaritalSqlRepository;
        private readonly Mock<ISqlUnitOfWork> mockSqlUnitOfWork;
        private readonly UpdateMaritalHandler handler;

        public UpdateMaritalTest()
        {
            mockMaritalSqlRepository = new Mock<IMaritalSqlRepository>();
            mockSqlUnitOfWork = new Mock<ISqlUnitOfWork>();
            handler = new UpdateMaritalHandler(mockMaritalSqlRepository.Object, mockSqlUnitOfWork.Object);
        }
        [Fact]
        public async Task Handle_ValidRequest_ReturnsSuccessResult()
        {
            // Arrange
            var request = new UpdateMaritalRequest
            {
                Id = 1,
                Name = "Updated Name"
            };
            ...
            mockMaritalSqlRepository.Verify(repo => repo.Update(sample), Times.Once);
