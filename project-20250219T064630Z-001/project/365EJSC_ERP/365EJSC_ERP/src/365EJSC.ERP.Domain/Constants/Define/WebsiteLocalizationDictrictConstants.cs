...
public class WebsiteLocalizationDictrictConstants
{
    ...
    public const string MSG_DICTRICT_ID_NOT_FOUND = $"{nameof(WebsiteLocalizationDictrict)} with this id was not found";
