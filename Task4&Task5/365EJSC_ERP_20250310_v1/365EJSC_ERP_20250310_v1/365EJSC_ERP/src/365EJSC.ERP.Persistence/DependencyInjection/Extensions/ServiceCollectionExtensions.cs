...
namespace _365EJSC.ERP.Persistence.DependencyInjection.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static IServiceCollection RegisterServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<ICompanyPositionSqlRepository, CompanyPositionSqlRepository>();
            services.AddScoped<ISalaryStructureSqlRepository, SalaryStructureSqlRepository>();
            ...
            services.AddScoped<ITrainingMajorSqlRepository, TrainingMajorSqlRepository>();
            services.AddScoped<IDegreeSqlRepository, DegreeSqlRepository>();
            services.AddScoped<IBankSqlRepository, BankSqlRepository>();
            services.AddScoped<IProductTypeSqlRepository, ProductTypeSqlRepository>();
            return services;
        }
    }
}