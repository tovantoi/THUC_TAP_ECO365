...
namespace _365EJSC.ERP.Presentation.Controllers.v1.Product
{
    /// <summary>
    /// Controller version 1 for bank apis
    /// </summary>
    [ApiVersion(1)]
    [Route(RouteConstant.API_PREFIX + RouteConstant.PRODUCT_TYPE_ROUTE)]
    public class ProductTypeController : ApiController
    {
        ...
        [MapToApiVersion(1)]
        [HttpPost]
        public async Task<IActionResult> CreateV1(CreateProductTypeRequest request)
        {
        ...
        [MapToApiVersion(1)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateV1(int id, [FromBody] UpdateProductTypeRequest request)
        {
            request.Id = id;
            var result = await mediator.Send(request);
            return Ok(result);
        ...
        {
            var command = new DeleteProductTypeRequest()
            {
                Id = id,
            };
        ...
        {
            var query = new GetDetailProductTypeRequest()
            {
                Id = id,
            };
