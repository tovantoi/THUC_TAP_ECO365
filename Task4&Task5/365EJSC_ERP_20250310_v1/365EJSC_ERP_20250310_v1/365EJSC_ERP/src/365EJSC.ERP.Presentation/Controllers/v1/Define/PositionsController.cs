...
namespace _365EJSC.ERP.Presentation.Controllers.v1.Define
{
    ...
    /// </summary>
    [ApiVersion(1)]
    [Route(RouteConstant.API_PREFIX + RouteConstant.POSITIONS_ROUTE)]
    public class PositionsController : ApiController
    {
        ...
        [MapToApiVersion(1)]
        [HttpPost]
        public async Task<IActionResult> CreateV1(CreateErpGeneralPositionRequest request)
        {
        ...
        [MapToApiVersion(1)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateV1(int id, [FromBody] UpdateErpGeneralPositionRequest request)
        {
            request.Id = id;
            var result = await mediator.Send(request);
            return Ok(result);
        ...
        {
            var command = new DeleteErpGeneralPositionRequest()
            {
                Id = id,
            };
        ...
        {
            var query = new GetDetailErpGeneralPositionRequest()
            {
                Id = id,
            };
