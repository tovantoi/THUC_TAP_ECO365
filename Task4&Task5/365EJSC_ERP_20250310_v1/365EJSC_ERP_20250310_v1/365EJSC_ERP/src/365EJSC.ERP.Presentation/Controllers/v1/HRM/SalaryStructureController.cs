...
namespace _365EJSC.ERP.Presentation.Controllers.v1.HRM
{
    ...
    /// </summary>
    [ApiVersion(1)]
    [Route(RouteConstant.API_PREFIX + RouteConstant.SALARY_STRUCTURE_ROUTE)]
    public class SalaryStructureController : ApiController
    {
        ...
        [MapToApiVersion(1)]
        [HttpPost]
        public async Task<IActionResult> CreateV1(CreateSalaryStructureRequest request)
        {
        ...
        [MapToApiVersion(1)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateV1(int id, [FromBody] UpdateSalaryStructureRequest request)
        {
            request.Id = id;
            var result = await mediator.Send(request);
            return Ok(result);
        ...
        {
            var command = new DeleteSalaryStructureRequest()
            {
                Id = id,
            };
        ...
        {
            var query = new GetDetailSalaryStructureRequest()
            {
                Id = id,
            };
