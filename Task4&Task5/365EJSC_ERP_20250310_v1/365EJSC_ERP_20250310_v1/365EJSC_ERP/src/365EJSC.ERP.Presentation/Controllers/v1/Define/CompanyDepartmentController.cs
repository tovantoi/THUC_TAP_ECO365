...
namespace _365EJSC.ERP.Presentation.Controllers.v1.Define
{
    ...
    /// </summary>
    [ApiVersion(1)]
    [Route(RouteConstant.API_PREFIX + RouteConstant.COMPANY_DEPARTMENT_ROUTE)]
    public class CompanyDepartmentController : ApiController
    {
        ...
        [MapToApiVersion(1)]
        [HttpPost]
        public async Task<IActionResult> CreateV1(CreateCompanyDepartmentRequest request)
        {
        ...
        [MapToApiVersion(1)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateV1(int id, [FromBody] UpdateCompanyDepartmentRequest request)
        {
            request.Id = id;
            var result = await mediator.Send(request);
            return Ok(result);
        ...
        {
            var command = new DeleteCompanyDepartmentRequest()
            {
                Id = id
            };
        ...
        {
            var query = new GetDetailCompanyDepartmentRequest()
            {
                Id = id,
            };
